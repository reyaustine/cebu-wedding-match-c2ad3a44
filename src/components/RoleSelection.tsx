...
import { User, Store, CalendarClock, ShieldCheck } from "lucide-react";
...
export const RoleSelection = () => {
  const roles = [
    ...
    },
    {
      id: "admin",
      title: "Admin",
      description: "Platform administrator responsible for verification and support",
      icon: <ShieldCheck className="h-10 w-10 text-wedding-500" />,
    },
  ];
  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-4xl mx-auto">
      {roles.map((role) => (
        <Card 
          key={role.id} 
          className="cursor-pointer hover:border-wedding-300 hover:shadow-md transition-all duration-300"
        >
              ...
              {role.id === "admin" && (
                <>
                  <li className="flex items-center gap-2">
                    ...
                    <span>Verify supplier accounts</span>
                  </li>
                  <li className="flex items-center gap-2">
                    <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4 text-green-600" viewBox="0 0 20 20" fill="currentColor">
                      <path fillRule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clipRule="evenodd" />
                    </svg>
                    <span>Manage disputes & reports</span>
                  </li>
                  <li className="flex items-center gap-2">
                    <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4 text-green-600" viewBox="0 0 20 20" fill="currentColor">
                      <path fillRule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clipRule="evenodd" />
                    </svg>
                    <span>Access analytics & reporting</span>
                  </li>
                </>
              )}
            </ul>
